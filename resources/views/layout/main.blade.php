...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    @auth
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('query') }}">列出所有車款</a>
                        </li>
                        <li class="nav-item">
                    ...
                    @else
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('reg') }}">註冊</a>
                        </li>
                    @endif
                </ul>
            </div>
    ...
    <!-- Page Header -->
    <header class="masthead" style="background-image: url(@yield('backgroundImageUrl')">
